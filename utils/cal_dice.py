...
def main():
    ...
    parser.add_argument('--data_path', default='/mnt/tiezheng/continue_learning_data/08_onehot/340', help='The path of your data')
    ...
    parser.add_argument('--out', default='/data2/tzhang/continue_learning/CLIP_Based_Continue_Learning/Dice_record/onehot')
    parser.add_argument('--save_file', default='dice_after_onehot_340.txt')
