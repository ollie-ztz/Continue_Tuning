...
def main():
    ...
    parser.add_argument('--data_path', default='/mnt/tiezheng/continue_learning_data/08_unet_base', help='The path of your data')
    ...
    parser.add_argument('--save_file', default='dice_unet_onehot_base.txt')
