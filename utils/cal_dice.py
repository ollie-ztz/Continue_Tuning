...
def main():
    ...
    parser.add_argument('--data_path', default='/mnt/tiezheng/continue_learning_data/08_unetonehot_R2/450', help='The path of your data')
    ...
    parser.add_argument('--backbone', default='unet', help='backbone [swinunetr or unet, unet_onehot, swinunetr_onehot]')
    parser.add_argument('--out', default='/data2/tzhang/continue_learning/CLIP_Based_Continue_Learning/Dice_record/Unet_onehot_R2')
