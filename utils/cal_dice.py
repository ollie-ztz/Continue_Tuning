...
def main():
    ...
    parser.add_argument('--data_path', default='/mnt/tiezheng/continue_learning_data/08_R1_after_part/260', help='The path of your data')
    ...
    parser.add_argument('--save_file', default='dice_after_260.txt')
