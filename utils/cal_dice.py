...
def main():
    ...
    parser.add_argument('--data_path', default='/mnt/tiezheng/continue_learning_data/08_onehot_compare/350', help='The path of your data')
    ...
    parser.add_argument('--backbone', default='swinunetr_onehot', help='backbone [swinunetr or unet]')
    parser.add_argument('--out', default='/data2/tzhang/continue_learning/CLIP_Based_Continue_Learning/Dice_record/onehot_compare')
    parser.add_argument('--save_file', default='dice_after_onehot_350.txt')
