...
def main():
    ...
    parser.add_argument('--data_path', default='/mnt/tiezheng/continue_learning_data/R1_after_part', help='The path of your data')
    ...
    parser.add_argument('--out', default='/data2/tzhang/Update/LargePseudoDataset/continue_learning_cri')
    parser.add_argument('--save_file', default='dice_after_part_480.txt')
