...
def main():
    # /mnt/tiezheng/continue_learning_data/08_unet_200full/350
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_path', default='/mnt/tiezheng/continue_learning_data/08_Swinonehot_R2/400', help='The path of your data')
    ...
    parser.add_argument('--backbone', default='swinunetr_onehot', help='backbone [swinunetr or unet, unet_onehot, swinunetr_onehot]')
    parser.add_argument('--out', default='/data2/tzhang/continue_learning/CLIP_Based_Continue_Learning/Dice_record/SW_onehot_R2')
    parser.add_argument('--save_file', default='dice_400.txt')
