...
def main():
    ...
    parser.add_argument('--data_path', default='/mnt/tiezheng/Unet_proof/270', help='The path of your data')
    ...
    parser.add_argument('--out', default='/data2/tzhang/continue_learning/CLIP_Based_Continue_Learning/Dice_record/Unet_proof')
    parser.add_argument('--save_file', default='dice_270.txt')
